...
'''
there will be some filters in this python app.
1)Gray Scale Image
2)Binary image
3)Blue
4)smoothing the image
5)Blurring the image
6)Detecting edge of the image
7)Saturation
8)Green
9)Red
10)Value
...
dict_1={1:'Gray scale image',2:'Binary image',3:'Blue',4:'smoothing the image',5:'Blurring the image',6:'Detecting the edge of image',7:'saturation',8:'Green',9:'Red',10:'Value',11:'Hue',12:'cropping the image',13:'Doubling the image',14:'Transposing the image',15:'sharpeing image'}
height=img.shape[0]
width=img.shape[1]
...
while(True):
    ...
    if num=='1':
        ...
        rotation_image=cv2.transpose(img)#this will convert the image of horizontal pixel elements into vertical pixel elements as in matrix
